...
export function PredictionLeaderboard({ matchId, refreshKey }: { matchId: number; refreshKey: number }) {
  ...
  if (loading) return <div className="h-16 animate-pulse rounded-xl bg-slate-200" />;
  if (predictions.length === 0) return <EmptyState icon="🔮" title="暂无预测" description="成为第一个预测的人！" />;
