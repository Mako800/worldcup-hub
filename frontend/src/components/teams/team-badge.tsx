...
export function TeamBadge({ name, nameZh, shortName, logoColor, score, isHome }: TeamBadgeProps) {
  return (
    <div className={`flex items-center gap-3 ${isHome === false ? "flex-row-reverse text-right" : ""}`}>
      <div
